...
namespace INTERCAL.Runtime
{
        ...
        ILogicalThreadAffinative, IExecutionContext
    {
        ...
        /// </summary>
        [Serializable]
        private abstract class Variable<T> : IVariable
        {
            ...
            /// </summary>
            protected Stack<T> StashStack = new Stack<T>();

            protected Variable(ExecutionContext ctx, string name)
            {
                Name = name;
                Owner = ctx;
            }
        ...
        /// </remarks>
        [Serializable]
        private class IntVariable : Variable<uint>, IVariable
        {
        ...
        /// <inheritdoc cref="Variable{T}" />
        [Serializable]
        private class ArrayVariable : Variable<Array>, IVariable
        {
        ...
        public void WriteIn(string identifier)
        {
            ...
            {
                if (!(_variables[identifier] is ArrayVariable av)) 
                    throw new IntercalException(Messages.E200);
                
                if (av.Rank != 1) Lib.Fail(Messages.E241);
    ...
    public static class Lib
    {
        ...
        /// library
        /// </summary>
        /// <param name="errcode">An error code from <see cref="Messages"/>.</param>
